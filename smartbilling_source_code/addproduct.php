...
echo "Current date and time is ".$today;
  ...
  $sql="insert into books(name,quantity,buy_price,sale_price,categorie_id,media_id,date)values('".$_POST['name']."','".$_POST['quantity']."','".$_POST['buy_price']."','".$_POST['sale_price']."','".$_POST['categorie_id']."','".$_POST['media_id']."','". $today."')";
