...
INSERT INTO `books` (`id`, `name`, `quantity`, `buy_price`, `sale_price`, `categorie_id`, `media_id`, `date`, `delete_status`) VALUES
...
INSERT INTO `sales_book` (`id`, `sales_id`, `product_id`, `quantity`, `unit_price`, `total`) VALUES
